...
function ServiceCard({
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl border border-foreground/10 bg-card/20 backdrop-blur-sm p-5 transition-all duration-500 group-hover:border-foreground/30 group-hover:bg-card/40 sm:p-6 md:p-8">
        {/* Line animation */}
        ...
        <h3 className="mb-3 font-sans text-xl font-semibold text-foreground transition-all duration-300 group-hover:translate-x-1 sm:text-2xl md:text-3xl">
          {service.title}
        </h3>
        <p className="mb-6 max-w-sm text-sm leading-relaxed text-foreground/80 transition-colors duration-300 group-hover:text-foreground/90 sm:text-base">
          {service.description}
        </p>
